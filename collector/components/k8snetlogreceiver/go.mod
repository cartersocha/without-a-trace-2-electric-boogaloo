module github.com/lightstep/without-a-trace/components/k8snetlogreciever

go 1.19

require (
	github.com/otterize/network-mapper v0.1.26
	github.com/otterize/network-mapper/src v0.0.0-20230727093008-8588fbb43543
...
require (
	...
	github.com/otterize/go-procnet v0.1.1 // indirect
